...
pub const Runtime = extern struct {
    ...
    marshal_value: *const fn (m: *abi.Marshal, x: Value) callconv(.c) void,
    ...
    new_map: *const fn (kvs: [*]const abi.Keyval, len: usize) callconv(.c) Value,
    ...
    unmarshal_value: *const fn (u: *abi.Unmarshal) callconv(.c) Value,
