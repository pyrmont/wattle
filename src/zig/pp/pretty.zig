...
//! is written once.
//!
//! ## The two allocations a raise strands
//!
...
///
/// The one raise in this file, and the reason `printJdnOne` answers a flag
/// rather than raising: the message is written once, here. `pp/format.zig`
