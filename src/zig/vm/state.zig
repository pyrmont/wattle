...
/// One interpreter's state. `janet_vm` is the thread's -- the storage below --
...
/// indirect
/// call that clobbers the caller-saved registers, so the cost is the spills
/// around it as much as the call.
///
