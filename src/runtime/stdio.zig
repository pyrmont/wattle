...
//!
//! **They are here because `stderr` is a macro**, and the translation renders
//! it a different way on each of this project's platforms -- an inline
//! function on macOS, a variable of opaque type on musl that Zig will not let
//! a many-pointer address, and on mingw a container-level constant whose
...
//! at a call site at all: naming it is a compile error there whatever is done
//! with the result.
//!
...
//!
//! Verified by compiling all six targets and writing through each handle.
//!
