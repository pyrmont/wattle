...
/// The value a socket field holds before one is assigned. **The POSIX value is
/// 0 rather than -1**, which is a valid descriptor; nothing reads it before
/// assigning, and the number is contract.
