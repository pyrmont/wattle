...
pub fn lib(env: *tables.Table) void {
    const entries = comptime [_]corefn.Entry{
        ...
        corefn.reg("array/slice", &nfunArraySlice, @src(), "(array/slice ind)\n(array/slice ind start)\n(array/slice ind start end)", "Takes a slice of ind, an indexed type, from start to end. The range is half open, " ++
