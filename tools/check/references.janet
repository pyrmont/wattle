...
# declare.
#
#     ./tools/check/references.janet           regenerate tools/check/references.txt
#     ./tools/check/references.janet --check    fail if the tree disagrees with it
#
# ## Why this exists
#
...
(def list-path "tools/check/references.txt")
...
(defn main [& argv]
  ...
  (buffer/push out "# Generated by `./tools/check/references.janet`; do not edit.\n#\n")
