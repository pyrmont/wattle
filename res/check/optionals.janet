...
#
#     ./res/check/optionals.janet           regenerate res/check/optionals.txt
#     ./res/check/optionals.janet --check   fail if the tree disagrees with it
#
...
(def list-path "res/check/optionals.txt")
...
(defn main [& argv]
  ...
  (buffer/push out "# Generated by `./res/check/optionals.janet`; do not edit.\n#\n")
