...
#
#     ./res/check/counters.janet           regenerate res/check/counters.txt
#     ./res/check/counters.janet --check   fail if the tree disagrees with it
#
...
(def list-path "res/check/counters.txt")
...
(defn main [& argv]
  ...
  (buffer/push out "# Generated by `./res/check/counters.janet`; do not edit.\n#\n")
