...
#
#     ./res/check/docblocks.janet           regenerate res/check/docblocks.txt
#     ./res/check/docblocks.janet --check   fail if the tree disagrees with it
#
# ## Why this exists
#
...
(def list-path "res/check/docblocks.txt")
...
(defn main [& argv]
  ...
  (buffer/push out "# Generated by `./res/check/docblocks.janet`; do not edit.\n#\n")
